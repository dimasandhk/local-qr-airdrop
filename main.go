...
<head>
	...
	<style>
		:root { --bg: #fff; --text: #000; --card-bg: #fff; --card-border: #ddd; --input-border: #ccc; }
		html.dark { --bg: #121212; --text: #f1f1f1; --card-bg: #1e1e1e; --card-border: #333; --input-border: #555; }
		...
		input[type=file] { margin: 20px 0; padding: 10px; border: 1px solid var(--input-border); border-radius: 5px; width: 100%%; box-sizing: border-box; background-color: var(--bg); color: var(--text); }
...
<body>
	<button class="theme-toggle" onclick="toggleTheme()" aria-label="Toggle Dark Mode" id="theme-icon">🌓</button>
	<div class="card">
