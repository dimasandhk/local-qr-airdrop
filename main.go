...
<head>
	...
	<style>
		:root { --bg: #ffffff; --text: #000000; --card-bg: #ffffff; --border: #dddddd; }
		[data-theme="dark"] { --bg: #121212; --text: #ffffff; --card-bg: #1e1e1e; --border: #333333; }
...
<body>
	...
	<script>document.getElementById('theme-icon').innerText = getTheme() === 'dark' ? '☀️' : '🌙';</script>
	<div class="card">
