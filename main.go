...
<head>
	...
	<style>
		:root { --bg-color: #ffffff; --text-color: #333333; --card-bg: #ffffff; --border-color: #dddddd; }
		:root.dark { --bg-color: #1a1a1a; --text-color: #f0f0f0; --card-bg: #2a2a2a; --border-color: #444444; }
		...
		input[type=file] { color: var(--text-color); background-color: var(--bg-color); margin: 20px 0; padding: 10px; border: 1px solid var(--border-color); border-radius: 5px; width: 100%%; box-sizing: border-box; }
...
<head>
	...
	<style>
		...
		:root.dark { --bg-color: #1a1a1a; --text-color: #f0f0f0; }
		body { background-color: var(--bg-color); color: var(--text-color); font-family: sans-serif; padding: 20px; text-align: center; max-width: 600px; margin: auto; transition: background-color 0.3s, color 0.3s; }
