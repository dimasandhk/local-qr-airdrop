...
<head>
	...
	<style>
		...
		[data-theme='dark'] { --bg: #1e1e1e; --text: #ffffff; --card-bg: #2d2d2d; --card-border: #444; }
		...
		input[type=file] { margin: 20px 0; padding: 10px; border: 1px solid var(--card-border); border-radius: 5px; width: 100%%; box-sizing: border-box; background: var(--card-bg); color: var(--text); }
...
<head>
	...
	<style>
		...
		[data-theme='dark'] { --bg: #1e1e1e; --text: #ffffff; }
		body { font-family: sans-serif; padding: 20px; text-align: center; max-width: 600px; margin: auto; background-color: var(--bg); color: var(--text); transition: background-color 0.3s, color 0.3s; }
