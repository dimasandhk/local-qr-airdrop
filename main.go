...
<head>
	...
	<script>
		// Initialization to prevent FOUC
	...
	<style>
		...
		input[type=file] { margin: 20px 0; padding: 10px; border: 1px solid var(--input-border); border-radius: 5px; width: 100%%; box-sizing: border-box; background: transparent; color: var(--text-color); }
...
<body>
	<button id="theme-icon" class="theme-toggle" onclick="toggleTheme()" title="Toggle Theme">🌓</button>
	<script>
