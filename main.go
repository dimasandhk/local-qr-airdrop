...
<head>
	...
	<style>
		:root { --bg: #ffffff; --text: #000000; --card-bg: #ffffff; --border: #cccccc; }
		[data-theme="dark"] { --bg: #121212; --text: #e0e0e0; --card-bg: #1e1e1e; --border: #333333; }
		...
		.theme-btn { position: absolute; top: 15px; right: 15px; background: none; border: none; font-size: 24px; cursor: pointer; }
	</style>
</head>
<body>
	<button id="theme-icon" class="theme-btn" onclick="toggleTheme()" title="Toggle Dark Mode">🌓</button>
	<div class="card">
