...
<head>
	...
	<style>
		:root { --bg: #ffffff; --text: #000000; --card-bg: #ffffff; --card-border: #ddd; }
		[data-theme="dark"] { --bg: #121212; --text: #e0e0e0; --card-bg: #1e1e1e; --card-border: #333; }
		body { font-family: sans-serif; padding: 20px; text-align: center; max-width: 600px; margin: auto; background-color: var(--bg); color: var(--text); transition: all 0.3s ease; }
		...
		input[type=file] { margin: 20px 0; padding: 10px; border: 1px solid var(--card-border); border-radius: 5px; width: 100%%; box-sizing: border-box; background-color: var(--card-bg); color: var(--text); }
		.card { border: 1px solid var(--card-border); background-color: var(--card-bg); padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); }
		.theme-toggle { position: absolute; top: 10px; right: 10px; background: none; border: none; font-size: 24px; cursor: pointer; color: var(--text); }
	</style>
	<script>
