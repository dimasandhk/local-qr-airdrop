...
<head>
	...
	<style>
		body { font-family: sans-serif; padding: 20px; text-align: center; max-width: 600px; margin: auto; transition: background-color 0.3s, color 0.3s; background-color: #ffffff; color: #000000; }
		:root.dark-mode body { background-color: #121212; color: #e0e0e0; }
		...
		input[type=file] { margin: 20px 0; padding: 10px; border: 1px solid #ccc; border-radius: 5px; width: 100%%; box-sizing: border-box; background-color: #fff; color: #000; }
		:root.dark-mode input[type=file] { background-color: #333; color: #e0e0e0; border-color: #555; }
		.card { border: 1px solid #ddd; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background-color: #fff; }
		:root.dark-mode .card { background-color: #1e1e1e; border-color: #333; box-shadow: 0 4px 8px rgba(0,0,0,0.5); }
		.theme-toggle { position: absolute; top: 20px; right: 20px; background: none; border: none; font-size: 24px; cursor: pointer; color: inherit; }
	</style>
</head>
<body>
