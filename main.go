...
<head>
	...
	<style>
		...
		:root.dark { --bg: #121212; --text: #e0e0e0; --card-bg: #1e1e1e; --card-border: #333; --input-bg: #2d2d2d; --input-border: #444; }
		...
		input[type=file] { margin: 20px 0; padding: 10px; border: 1px solid var(--input-border); border-radius: 5px; width: 100%%; box-sizing: border-box; background-color: var(--input-bg); color: var(--text); }
...
<body>
	...
	<script>
		...
		if (document.documentElement.classList.contains('dark')) toggle.textContent = '☀️';
