...
<head>
	...
	<style>
		...
		body.dark-mode input[type=file] { background: #333; color: #fff; border-color: #555; }
		.card { border: 1px solid #ddd; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: #fff; transition: background-color 0.3s, border-color 0.3s; }
		body.dark-mode .card { background: #2d2d2d; border-color: #444; }
		.theme-toggle { position: absolute; top: 20px; right: 20px; background: none; border: none; font-size: 24px; cursor: pointer; padding: 5px; }
	</style>
</head>
<body>
