...
<head>
	...
	<style>
		...
		/* Dark Mode Styles */
		html.dark body { background-color: #1a1a1a; color: #f0f0f0; }
		html.dark .card { background-color: #2d2d2d; border-color: #444; box-shadow: 0 4px 8px rgba(0,0,0,0.3); }
		html.dark input[type=file] { background-color: #333; color: #fff; border-color: #555; }
