...
<head>
	...
	<style>
		...
		input[type=file] { background-color: var(--input-bg); color: var(--input-text); margin: 20px 0; padding: 10px; border: 1px solid var(--input-border); border-radius: 5px; width: 100%%; box-sizing: border-box; }
...
<body>
	<button class="theme-toggle" aria-label="Toggle Dark Mode" onclick="toggleTheme()" id="theme-icon">🌙</button>
	<div class="card">
