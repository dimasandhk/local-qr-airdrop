...
<head>
	...
	<style>
		:root { --bg-color: #ffffff; --text-color: #000000; --card-bg: #ffffff; --card-border: #ddd; --input-border: #ccc; --input-bg: #ffffff; --input-text: #000000; }
		:root.dark-mode { --bg-color: #1a1a1a; --text-color: #f0f0f0; --card-bg: #2d2d2d; --card-border: #444; --input-border: #555; --input-bg: #333; --input-text: #f0f0f0; }
		body { background-color: var(--bg-color); color: var(--text-color); font-family: sans-serif; padding: 20px; text-align: center; max-width: 600px; margin: auto; }
		...
		input[type=file] { margin: 20px 0; padding: 10px; border: 1px solid var(--input-border); border-radius: 5px; width: 100%%; box-sizing: border-box; background-color: var(--input-bg); color: var(--input-text); }
...
<body>
	<button class="theme-toggle" id="theme-toggle-btn" onclick="toggleTheme()" aria-label="Toggle Dark Mode">🌓</button>
	<div class="card">
